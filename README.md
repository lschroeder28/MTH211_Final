...
Example of Rank-1: $u=\pmatrix
{x & y & z}$ and $v^T=(a,b,c)$ so $uv^T=\pmatrix{ax&bx&cx \\ ay&by&cy \\ az&bz&cz}$ $\leftarrow$ every column is a multiple of $u$ and every row is a multiple of $v$
